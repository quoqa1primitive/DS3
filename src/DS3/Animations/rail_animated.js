...
function getClips(){
  ...
  clips.push({
    ...
    "counter": 0, "hider": [line1PosX, line1PosY, 2*interval*lineWidth],
  ...
  clips.push({
    ...
    "pos2": [-xScale*(adjustedArr2.length+adjustedA2B3.length-2), line1PosY, 2*interval*lineWidth],
    "pos3": [0, line1PosY, 2*interval*lineWidth],
    "counter": 40, "hider": [line1PosX, line1PosY, 900],
  ...
  clips.push({
    ...
    "pos2": [-xScale*(adjustedArr2.length+adjustedA2B3.length-2), line1PosY, 2*interval*lineWidth],
    "pos3": [0, line1PosY, 2*interval*lineWidth],
    "counter": 40, "hider": [line1PosX, line1PosY, 2*interval*lineWidth],
  ...
  clips.push({
    ...
    "counter": 80, "hider": [line1PosX+500, line1PosY, 0],
...
function getTransitions(){
  ...
  transitions.push({
    "target": "line1",
    "from": {"frame": 1, "clip": "overall graph"}, "to": {"frame": 2, "clip": "line3 move"},
    "easing": "bezier",
    "motion": [{ "type": "linear", "args": {} }]
  });
  transitions.push({
